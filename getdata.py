...
# This file is used to capture a video data and save it in the root directory.
"""
...
for i, dev in enumerate(devices):
	...
	if i == 0:
		dev.activate("license:50230:hwP9COQhDF2O9fFC") #activate device using python api
		# 打印设备激活状态
